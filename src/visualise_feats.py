...
def explore_and_visualize_features(participant='sub-01'):
    ...
    try:
        feat = np.load(f'/Users/rritahajrizi/BCI-Brain2Speech/data/processed/features/{participant}_feat.npy')
        melSpec = np.load(f'/Users/rritahajrizi/BCI-Brain2Speech/data/processed//features/{participant}_spec.npy')
        words = np.load(f'/Users/rritahajrizi/BCI-Brain2Speech/data/processed//features/{participant}_procWords.npy', allow_pickle=True)
        feature_names = np.load(f'/Users/rritahajrizi/BCI-Brain2Speech/data/processed//features/{participant}_feat_names.npy', allow_pickle=True)
...
if __name__ == "__main__":
    # You can run this for multiple participants
    participants = ['sub-01', 'sub-02']  # Add all your participants
    ...
    for participant in participants:
        ...
        # Check if features exist for this participant
        feat_path = f'./features/{participant}_feat.npy'
